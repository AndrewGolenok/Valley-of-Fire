					...
					if global.p_totem[2] != -1
						...
						if totems_y[2] = 0
							...
							if totems_x[2] < 300
								...
								{
								if global.p_totem[1] != -1
									{ totems_y[2] = totems_y[1]; totems_x[1] = 350; totems_y[1] = -(global.height / 2); global.p_totem[2] = global.p_totem[1]; global.p_totem[1] = -1; }
									else
									{ totems_y[2] = -(global.height / 2 - 100 + totem_w); totems_x[2] = 0; }
								}
							}
						}
					///////////
