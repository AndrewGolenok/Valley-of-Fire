...
if global.player_rank <= 3
	{ bottle_all = 5; bottle_red = choose(0, 1); min_time[2,1] = 90; }
if global.player_rank < 7  && global.player_rank >= 4
	{ bottle_all = 5; bottle_red = choose(0, 0, 1); min_time[2,1] = 70; }
if global.player_rank < 10 && global.player_rank >= 7
	{ bottle_all = 4; bottle_red = choose(0, 0, 0, 1); min_time[2,1] = 60; }
if global.player_rank < 13 && global.player_rank >= 10
	{ bottle_all = 4; bottle_red = choose(0, 0, 0, 0, 1); min_time[2,1] = 40; }
if global.player_rank < 15 && global.player_rank >= 13
	{ bottle_all = 3; bottle_red = choose(0, 0, 0, 0, 1); min_time[2,1] = 30; }
if global.player_rank >= 15
	{ bottle_all = 2; min_time[2,1] = 20; }
