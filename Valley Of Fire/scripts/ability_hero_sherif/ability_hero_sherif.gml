...
if shoot = 2 or shoot = 3
	...
	draw_sprite_ext(s_bullet_revolver, 0, sx - 28, sy - 40, sc * scale - 0.025, scale + 0.025, 0, c_white, 1 * bullet_alpha);
	draw_sprite_ext(s_bullet_revolver, 0, sx - 28, sy - 40, sc * scale - 0.025, scale + 0.025, 0, c_orange, 0.5 * bullet_alpha);
	draw_sprite_ext(s_bullet_revolver, 0, sx - 28, sy - 40, sc * scale - 0.025, scale + 0.025, 0, c_yellow, 0.2 * bullet_alpha);
